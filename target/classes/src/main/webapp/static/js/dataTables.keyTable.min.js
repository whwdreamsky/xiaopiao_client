...
(function(e) {
    ...
    n = function(a, b) {
        ...
        this.c = e.extend(!0, {},
        l.defaults.keyTable, n.defaults, b);
        this.s = {
            dt: new l.Api(a),
            enable: !0,
            focusDraw: !1,
    ...
    e.extend(n.prototype, {
        ...
        _constructor: function() {
            ...
            e(b.table().body()).on("click.keyTable", "th, td",
            function(c) {
                if (!1 !== a.s.enable) {
                    var d = b.cell(this);
            ...
            e(k).on("keydown.keyTable",
            function(b) {
                a._key(b)
            });
            if (this.c.blurable) e(k).on("mousedown.keyTable",
            function(c) {
                e(c.target).parents(".dataTables_filter").length && a._blur();
                e(c.target).parents().filter(b.table().container()).length || e(c.target).parents("div.DTE").length || e(c.target).parents().filter(".DTFC_Cloned").length || a._blur()
            });
        ...
        _editor: function(a, b) {
            var c = this.s.dt,
            d = this.c.editor;
            16 !== a && (b.stopPropagation(), 13 === a && b.preventDefault(), d.inline(this.s.lastFocus.cell.index()), e("div.DTE input, div.DTE textarea").select(), c.keys.enable(this.c.editorKeys), c.one("key-blur.editor",
            function() {
            	console.log(c)
        ...
        _focus: function(a, b, c, d) {
            ...
            if (this.s.enable) {
                ...
                if ( - 1 !== f.length && (a < f.start || a >= f.start + f.length)) this.s.focusDraw = !0,
                ...
                function() {
                    ...
                    if (c === o || !0 === c) this._scroll(e(m), e(k.body), g, "offset"),
                    c = h.table().body().parentNode,
                    c !== h.table().header().parentNode && (c = e(c.parentNode), this._scroll(c, c, g, "position"));
                    this.s.lastFocus = {
                        cell: f,
                        node: f.node(),
                        relative: {
        ...
        _tabInput: function() {
            ...
            if ( - 1 != c) e('<div><input type="text" tabindex="' + c + '"/></div>').css({
                ...
                width: 0,
                overflow: "hidden"
            }).insertBefore(b.table().node()).children().on("focus",
            function(c) {
        ...
        _updateFixedColumns: function(a) {
            ...
            c = b.settings()[0];
            if (c._oFixedColumns) {
                var d = c.aoColumns.length - c._oFixedColumns.s.iRightColumns; (a < c._oFixedColumns.s.iLeftColumns || a > d) && b.fixedColumns().update()
            }
        }
    });
    n.defaults = {
    ...
    l.ext.selector.cell.push(function(a, b, c) {
        ...
        if (!a || b === o) return c;
        for (var e = 0,
        h = c.length; e < h; e++)(!0 === b && a.focused(c[e]) || !1 === b && !a.focused(c[e])) && d.push(c[e]);
        return d
    });
    e(k).on("preInit.dt.dtk",
    function(a, b) {
        if ("dt" === a.namespace) {
            var c = b.oInit.keys,
            d = l.defaults.keys;
