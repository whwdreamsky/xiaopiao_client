/*!
 ...
 漏2016 SpryMedia Ltd - datatables.net/license
*/
(function(d) {
    ...
    d.extend(l.prototype, {
        ...
        _buildButton: function(a, b) {
            ...
            function(b) {
                b.preventDefault(); ! k.hasClass(c.disabled) && a.action && r(b, h, k, a);
                k.blur()
            }).on("keyup.dtb",
            function(b) {
            ...
            e.tag ? (g = d("<" + e.tag + "/>").html(f(a.text)).addClass(e.className), "a" === e.tag.toLowerCase() && g.attr("href", "#"), k.append(g)) : k.html(f(a.text)); ! 1 === a.enabled && k.addClass(c.disabled);
    ...
    function(a) {
        if (this.context.length) {
            ...
            }).toArray() : null, h = b.cells(c.rows, c.columns, c.modifier), f = h.render(c.orthogonal).toArray(), h = h.nodes().toArray(), j = a.length, k = 0 < j ? f.length / j: 0, l = Array(k), m = 0, n = 0; n < k; n++) {
                for (var o = Array(j), q = 0; q < j; q++) o[q] = c.format.body(f[m], n, q, h[m]),
                m++;
                l[n] = o
            }
            return {
