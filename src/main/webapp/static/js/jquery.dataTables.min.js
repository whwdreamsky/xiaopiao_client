...
sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"第一页",sLast:"最后一页",sNext:"下一页",sPrevious:"上一页"},sEmptyTable:"表中无数据",sInfo:"_START_ - _END_ / 找到 _TOTAL_ 项",sInfoEmpty:"0 - 0 / 0 项",sInfoFiltered:"(共 _MAX_ 项)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"每页 _MENU_ 项",sLoadingRecords:"载入中...",sProcessing:"处理中...",sSearch:"查找:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"没有找到匹配的结果"},
